                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="nama_sekolah" class="form-control" placeholder="sekolah">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="npsn_sekolah" class="form-control" placeholder="NPSN">
                                <div class="text-danger">
                                    @error('npsn_sekolah')
                                        {{ $message }}
                                    @enderror
...
<script>
    ...
    var curLocation = [-3.314364214631249, 114.59249471889544];
